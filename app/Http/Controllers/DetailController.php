...
class DetailController extends Controller
{
    ...
    public function export_excel()
    {
        ...
        $sheet->setCellValue('C1', 'Nama Barang'); // menukar kolom nama barang lebih dulu
        ...
        foreach ($detail as $key => $value) {
            ...
            $sheet->setCellValue('C' . $baris, $value->barang->barang_nama); // nama barang dulu
            $sheet->setCellValue('D' . $baris, $value->harga); // harga setelah nama barang
