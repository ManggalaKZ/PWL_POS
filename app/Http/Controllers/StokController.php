...
class StokController extends Controller
{
    ...
    {
        $stok = StokModel::select('stok_id', 'supplier_id', 'barang_id', 'user_id', 'stok_tanggal', 'stok_jumlah')->with('barang')->with('user')->with('supplier')->get();
    ...
    public function export_pdf()
    {
        ...
        $html .= '<th>stok_tanggal</th>';
        $html .= '<th>stok_jumlah</th>';
        $html .= '</tr>';
        $html .= '</thead>';
        $html .= '<tbody>';
        ...
        foreach ($stok as $stok) {
            $html .= '<tr>';
            $html .= '<td>' . $no . '</td>';
            $html .= '<td>' . htmlspecialchars($stok->stok_id) . '</td>'; // escape untuk keamanan
            $html .= '<td>' . htmlspecialchars($stok->barang_id) . '</td>'; // escape untuk keamanan
            $html .= '<td>' . htmlspecialchars($stok->user_id) . '</td>'; // escape untuk keamanan
            $html .= '<td>' . htmlspecialchars($stok->supplier_id) . '</td>'; // escape untuk keamanan
            $html .= '<td>' . htmlspecialchars($stok->stok_tanggal) . '</td>'; // escape untuk keamanan
            $html .= '<td>' . htmlspecialchars($stok->stok_jumlah) . '</td>'; // escape untuk keamanan
            $html .= '</tr>';
            $no++;
        }
        ...
        $filename = 'Data_Stok_' . date('Y-m-d_H-i-s') . '.pdf';
